define(['jcookie'], () => {
    return {
        init: function() {
            ...
            $.ajax({
                url: 'http://10.31.161.116/dashboard/Haier/php/detail.php',
                data: {
                    sid: $sid
                },
                dataType: 'json'
            ...
            $('.p-btn a').on('click', function() {
                ...
                // function Zoom(wrap, hoverbox, l, t, x, y, h_w, h_h, bf) {
                //     let moveX = x - l - (h_w / 2);
                //     //鼠标区域距离
                //     let moveY = y - t - (h_h / 2);
                //     //鼠标区域距离
                ...
                //     }
                //     //判断鼠标使其不跑出图片框
                //     let zoomX = bf.width() / wrap.width()
                //     //求图片比例
                //     let zoomY = bf.height() / wrap.height()
                ...
                // function Zoomhover(wrap, hoverbox, bf) {
                //     let l = wrap.offset().left;
                //     let t = wrap.offset().top;
                //     let w = hoverbox.width();
                //     let h = hoverbox.height();
                //     let time;
                //     $("#spic img,.hoverbox").mouseover(function(e) {
                //         let x = e.pageX;
                //         let y = e.pageY;
                //         $(".hoverbox,#bf").show();
                //         hoverbox.css("opacity", "0.3")
                //         time = setTimeout(function() {
                //             Zoom(wrap, hoverbox, l, t, x, y, w, h, bf)
                //         }, 1)
                ...
                // }
                // $(function() {
                //     Zoomhover($("#spic img"), $(".hoverbox"), $("#bf img"));
                // })
            });
        }
    }
